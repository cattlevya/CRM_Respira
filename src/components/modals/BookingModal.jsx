                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                <option value="">-- Pilih Riwayat Diagnosa --</option>
                                {history.map(h => (
                                    <option key={h.id} value={h.id}>
                                        {new Date(h.created_at).toLocaleDateString()} - {h.final_result} ({h.confidence_score}%)
                                    </option>
                                ))}
                            </select>
                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        required
                                        className={cn(
                                            "w-full p-3 bg-slate-50 border rounded-xl text-sm focus:outline-none focus:ring-2 transition-all",
                                            conflictError
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 min-h-[80px]"
