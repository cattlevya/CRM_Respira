...
const TopNav = ({ onMenuToggle }) => {
    ...
    return (
        <>
            <header className="h-[72px] bg-white/90 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 px-4 md:px-8 flex items-center justify-between shadow-sm">
                {/* Left: Logo */}
